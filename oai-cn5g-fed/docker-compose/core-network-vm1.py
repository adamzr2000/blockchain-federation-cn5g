...
BASIC_W_NRF = 'docker-compose-basic-nrf-vm1.yaml'
...
COMPOSE_CONF_MAP = {
    'docker-compose-mini-nrf.yaml': 'vm1-conf/mini_nrf_config.yaml',
    'docker-compose-mini-nonrf.yaml' : 'vm1-conf/mini_nonrf_config.yaml',
    'docker-compose-basic-nrf-vm1.yaml' : 'vm1-conf/basic_nrf_config.yaml',
    'docker-compose-basic-vpp-nrf.yaml' : 'vm1-conf/basic_vpp_nrf_config.yaml',
    'docker-compose-basic-nrf-ebpf.yaml' : 'vm1-conf/basic_nrf_config_ebpf.yaml',
    'docker-compose-basic-vpp-pcf-redirection.yaml' : 'vm1-conf/redirection_steering_config.yaml',
    'docker-compose-basic-vpp-pcf-steering.yaml' : 'vm1-conf/redirection_steering_config.yaml'
}
